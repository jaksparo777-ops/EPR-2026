...
**Document Reference:** BRD-ERP-2026-V1.2  
**Date:** May 19, 2026  
...
| Requirement ID | Requirement Description | Implementation Details |
| :--- | :--- | :--- |
| **REQ-PROD-004** | Worker-Grouped Assigned WIP. | Group outstanding WIP entries directly under deep-blue worker headers (`👤`) with pending item details, pending quantities, and an instant **Mark IN** button. |
...
| **REQ-PKG-003** | **Physical Carton Warehouse Shelf**. | Live warehouse shelf displaying ready cartons, nested carton item breakdowns, and piece-to-carton ratios. |

### F. Client Dispatch & Outbound Ledger Sync
| Requirement ID | Requirement Description | Implementation Details |
| :--- | :--- | :--- |
| **REQ-DSP-001** | **Premium Dual-Tab Dispatch Drawer**. | **Tab 1 (Select Ready Cartons)** renders a checkbox list of ready cartons with a live piece and weight summation bar. **Tab 2 (Manual Pieces Override)** supports entering manual loose quantities with auto-weight estimates. |
